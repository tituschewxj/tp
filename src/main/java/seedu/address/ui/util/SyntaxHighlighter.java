...
public class SyntaxHighlighter {
    ...
    /**
     * Generates rich-text lines, split by newline, with basic syntax highlighting applied to it,
     * generated by {@code generateLine}.
     *
     * @see #generateLine
     */
    public List<TextFlow> generateLines(String lines) {
